...
NOTES = {
    ...
    "VOICE_VAD_THRESHOLD": "OpenAI server-VAD speech threshold 0–1 (default 0.6; OpenAI's own default 0.5 fires on room noise).",
...
GROUPS = {
    ...
    "VOICE_LANG": "Voice", "VOICE_VAD_THRESHOLD": "Voice", "VOICE_VAD_SILENCE_MS": "Voice", "VOICE_VAD_PREFIX_MS": "Voice",
