...
SITE_TARGET = 6400
SITE_CEILING = 7800      # ratchet — lower with every cut, never raise (16,044 → 12,102 it5 → 10,532 it6 → 9,582 it7 → 8,468 it8 → 8,2xx it9; it9 also fixed _TAG, which had hidden "(< 1.5 s) … > 60 %" spans — earlier totals were ~1–3 % low)
